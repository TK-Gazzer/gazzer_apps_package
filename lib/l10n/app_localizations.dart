...
abstract class AppLocalizations {
  ...
  /// No description provided for @statusHandover.
  ///
  /// In en, this message translates to:
  /// **'Handover'**
  String get statusHandover;
  ...
  /// No description provided for @statusAwaitingCustomer.
  ///
  /// In en, this message translates to:
  /// **'Awaiting Customer'**
  ...
  /// No description provided for @statusRefundRequested.
  ///
  /// In en, this message translates to:
  /// **'Refund Requested'**
  String get statusRefundRequested;

  /// No description provided for @statusRefundRequestCanceled.
  ///
  /// In en, this message translates to:
  /// **'Refund Request Canceled'**
  String get statusRefundRequestCanceled;
